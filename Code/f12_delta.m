...
function out = f12_delta(in, R, Rl, Xl, Xarm, vgrid)
    ...
    out(10,:) = [idcsum/2 - idcdif/4,   idcsum - idcdif/2, - vdcdif/2 - vdcsum/4, vdcdif + vdcsum/2, reiacsum/2 - reiacdif/4, imiacsum/2 - imiacdif/4,   reiacsum - reiacdif/2,   imiacsum - imiacdif/2, revacdif + revacsum/2, imvacdif + imvacsum/2, - revacdif/2 - revacsum/4, - imvacdif/2 - imvacsum/4];
